...
variable "aurora_cluster_alarm" {
  type = list(object({
    ...
    // Cluster AuroraVolumeBytesLeftTotal
    aurora_auroravolumebyteslefttotal_evaluation_periods = string
    aurora_auroravolumebyteslefttotal_period             = string
    aurora_auroravolumebyteslefttotal_statistic          = string
    aurora_auroravolumebyteslefttotal_threshold          = string

    // Cluster DMLLatency
    aurora_dmllatency_evaluation_periods = string
