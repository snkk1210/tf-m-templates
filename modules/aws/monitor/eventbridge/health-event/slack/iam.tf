...
resource "aws_iam_role" "lambda_role" {
  name               = "${var.common.project}-${var.common.environment}-health-event-slack-notify-lambda-role${var.sfx}"
...
resource "aws_iam_policy" "lambda_to_ssm" {
  name   = "${var.common.project}-${var.common.environment}-health-event-slack-notify-lambda-policy${var.sfx}"
  path   = "/"
